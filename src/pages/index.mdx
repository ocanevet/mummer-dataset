...
import annotations from "../assets/annotations.jpg";
...
<Header
  ...
  links={[
    ...
    {
      name: "Data",
      url: "https://zenodo.org/records/3989642",
...
<Figure caption="Example of face annotations">
    <Image source={annotations} altText="Example of face annotations" />
</Figure>
...
The output of a tracker system can be evaluated in the same way as for the [MOT challenge](https://motchallenge.net/), using [MATLAB code](https://motchallenge.net/devkit/) or [Python code](https://github.com/cheind/py-motmetrics).
We also provide a [baseline system](https://github.com/idiap/ihper).
...
<TwoColumns>
  <Figure slot="left" caption="An easy sequence (only 2 protagonists, no passerby)">
    <YouTubeVideo videoId="HBCBF7iL5CU" />
  </Figure>
  <Figure slot="right" caption="A hard sequence (3 protagonists, multiple passerby)">
    <YouTubeVideo videoId="LbD4J3YPiJs" />
  </Figure>
</TwoColumns>
